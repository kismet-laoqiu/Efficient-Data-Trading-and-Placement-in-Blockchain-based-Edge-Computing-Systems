...
import lombok.Data;
import com.example.demo.blockchain.util.Base58Check;
...
public class Wallet implements Serializable {
    ...
    public String getAddress() {
        try {
            ...
            byte[] ripemdHashedKey = BlockchainAddressUtils.ripeMD160Hash(this.getPublicKey());
            ...
            // 3. 计算校验码
            byte[] checksum = BlockchainAddressUtils.checksum(versionedPayload);
